"""
Django settings for E_PeepHole project.
...
SECRET_KEY = 'django-insecure-0fh&jaj4y0u+=xe8()dqy=%+rfj64ct(*mm$erpe)h#hc3aog$'
...
WSGI_APPLICATION = 'E_PeepHole.wsgi.application'
